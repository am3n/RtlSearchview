package ir.am3n.rtlsearchview.db;
...
public class HistoryContract {
    ...
    private static String initAuthority() {
        String authority = "ir.am3n.rtlsearchview.defaultsearchhistorydatabase";

        try {
            ClassLoader clazzLoader = HistoryContract.class.getClassLoader();
            Class<?> clazz = clazzLoader.loadClass("com.saco.hamsi.MsvAuthority");
